...
namespace ArcheAge.ArcheAge.Network
{
    ...
    public static class DelegateList
    {
        ...
        private static void RegisterDelegates()
        {
            ...
            switch (_clientVersion)
            {
                ...
                case "1": //1.0.1406 Feb 11 2014
                    ...
                    Register(0x01, 0x0025, OnPacketReceive_0x01_CSSpawnCharacter_0x0025); //13
                    //other
        ...
        private static void OnPacketReceive_0x01_NP_CSMoveUnitPacket_0x0088(ClientConnection net, PacketReader reader)
        {
            ...
            Uint24 bc = reader.ReadUInt24();
            reader.Offset += 6; //

            float x = Helpers.ConvertX(reader.ReadByteArray(3));
            float y = Helpers.ConvertY(reader.ReadByteArray(3));
            float z = Helpers.ConvertZ(reader.ReadByteArray(3));
        ...
        private static void OnPacketReceive_0x01_CSCreateCharacter_0x0021(ClientConnection net, PacketReader reader)
        {
            ...
            float x = Helpers.ConvertX(BitConverter.GetBytes(newCharacter.X));
            float y = Helpers.ConvertY(BitConverter.GetBytes(newCharacter.Y));
            float z = Helpers.ConvertZ(BitConverter.GetBytes(newCharacter.Z));
            ...
            CharacterHolder.InsertOrUpdate(newCharacter); //записываем в базу character_records
        ...
        */
        ...
        public static void OnPacketReceive_0x01_CSSelectCharacter_0x0024(ClientConnection net, PacketReader reader)
        {
            ...
            CharacterList = CharacterHolder.LoadCharacterData(accountId);
        ...
        {
            net.SendAsyncHex(new NP_Hex("0700dd05f2bdb15010" +
                                        "2a00dd056f6fcc01d3a2724213e3b3e05321512c00dd0205d012452606e6b6865727f7c797704010e0b081512c00dd021300157f26060000000060bee1d96c0100000000058ef05d96663707d219375020f0b62d01007dd3e50f" +
                                        "" +
                                        "0800dd0520b18151" +
                                        "0f00dd0552379ac797704010e0b0815186" +
                                        "0800dd0520a188501140"));
        }
        public static void Onpacket0201(ClientConnection net, PacketReader reader)
        {
            ...
            if (b3 == 0x0)
            {
                ...
                net.SendAsyncHex(new NP_Hex("1e00dd020f000f00735f7069726174655f69736c616e6400000000000000000" +
                                            "14d00dd05e1606b03c3a31536778cd1e4324092a4fb031865b9ca6f4768d0bf8f29288d0aa62032df76266a421005dc04e238f2c494643405d5a5754516e6b7875626f6c797704010e0b0815152f322" +
                                            ...
                                            "2300dd0523e85c835223f4c494643405d5a5754516e6b6865727f7c797704010e0b0815142" +
                                            "0a00dd058b7cf511e0b08151"));
            }
            else if (b3 == 0x01)
            {
